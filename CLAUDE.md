...
| 計畫書 | 工單範圍 | 說明 | 狀態 |
|--------|----------|------|------|
| P2-A 可擴展架構 | 0317-0330 | 擴充包系統、性狀處理器、規則引擎 | 待開發 |
| P2-B 前端 UI | 0331-0350 | 卡牌設計、動畫、響應式 | 待開發 |
| P2-C 資料庫 | 0351-0360 | 遊戲紀錄、排行榜、成就 | 待開發 |
| P2-D 品質保證 | 0361-0375 | 斷線重連、行動裝置、E2E 測試 | 待開發 |

### 演化論計畫書

| 計畫書 | 位置 | 說明 |
|--------|------|------|
| 開發計畫書 v2.0 | `docs/演化論/PLAN_EVOLUTION_DEVELOPMENT.md` | 總體規劃 |
| 第二階段總覽 | `docs/演化論/PLAN_EVOLUTION_PHASE2_OVERVIEW.md` | P2 總覽 |
| P2-A 架構設計 | `docs/演化論/PLAN_EVOLUTION_PHASE2_ARCHITECTURE.md` | 可擴展架構 |
| P2-B UI 設計 | `docs/演化論/PLAN_EVOLUTION_PHASE2_UI.md` | 前端 UI |
| P2-C 資料庫 | `docs/演化論/PLAN_EVOLUTION_PHASE2_DATABASE.md` | 資料持久化 |
| P2-D 品質保證 | `docs/演化論/PLAN_EVOLUTION_PHASE2_QUALITY.md` | 品質與測試 |
