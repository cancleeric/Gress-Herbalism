...
jest.mock('./components/common', () => ({
  ...
  Lobby: function MockLobby() { return <div className="lobby"><h1>本草 Herbalism</h1><p>3-4 人推理卡牌遊戲</p></div>; },
  ...
  EvolutionLobbyPage: function MockEvolutionLobbyPage() { return <div>EvolutionLobby</div>; },
}));
