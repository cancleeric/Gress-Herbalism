...
describe('Redux Selectors', () => {
  ...
  const mockState = { herbalism: mockHerbalism };
  ...
  describe('selectGameRoomState', () => {
    ...
    test('不同輸入應返回不同引用', () => {
      const result1 = selectGameRoomState(mockState);
      const newState = { herbalism: { ...mockHerbalism, gamePhase: 'finished' } };
  ...
  describe('selectCurrentPlayer', () => {
    ...
    test('players 為空時應返回 null', () => {
      const result = selectCurrentPlayer({ herbalism: { ...mockHerbalism, players: [] } });
      expect(result).toBeNull();
    });

    test('currentPlayerIndex 超出範圍時應返回 null', () => {
      const result = selectCurrentPlayer({ herbalism: { ...mockHerbalism, currentPlayerIndex: 99 } });
      expect(result).toBeNull();
    });

    test('players 為 undefined 時應返回 null', () => {
      const result = selectCurrentPlayer({ herbalism: { ...mockHerbalism, players: undefined } });
      expect(result).toBeNull();
    });
  });
  ...
  describe('selectActivePlayers', () => {
    ...
    test('players 為空時應返回空陣列', () => {
      const result = selectActivePlayers({ herbalism: { ...mockHerbalism, players: [] } });
      expect(result).toEqual([]);
    });

    test('players 為 undefined 時應返回空陣列', () => {
      const result = selectActivePlayers({ herbalism: { ...mockHerbalism, players: undefined } });
      expect(result).toEqual([]);
    });
  });
  ...
  describe('selectGameHistory', () => {
    ...
    test('gameHistory 為 undefined 時應返回空陣列', () => {
      const result = selectGameHistory({ herbalism: { ...mockHerbalism, gameHistory: undefined } });
      expect(result).toEqual([]);
    });
  });
  ...
  describe('selectWinner', () => {
    ...
    test('有勝利者時應返回勝利者', () => {
      const result = selectWinner({ herbalism: { ...mockHerbalism, winner: 'player-1' } });
